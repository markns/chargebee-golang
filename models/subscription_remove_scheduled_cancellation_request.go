...
func (m *SubscriptionRemoveScheduledCancellationRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SubscriptionRemoveScheduledCancellationRequest) UnmarshalBinary(b []byte) error {
	var res SubscriptionRemoveScheduledCancellationRequest
