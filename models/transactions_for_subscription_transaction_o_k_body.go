...
func (m *TransactionsForSubscriptionTransactionOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TransactionsForSubscriptionTransactionOKBody) validateList(formats strfmt.Registry) error {
...
func (m *TransactionsForSubscriptionTransactionOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TransactionsForSubscriptionTransactionOKBody) UnmarshalBinary(b []byte) error {
