...
type ListPaymentSourceOKBody struct {
	...
	// list
	List []*PaymentSourceResponse `json:"list"`
...
func (m *ListPaymentSourceOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListPaymentSourceOKBody) validateList(formats strfmt.Registry) error {
...
func (m *ListPaymentSourceOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListPaymentSourceOKBody) UnmarshalBinary(b []byte) error {
