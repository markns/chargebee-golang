...
func (m *PaymentsForInvoiceTransactionOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentsForInvoiceTransactionOKBody) validateList(formats strfmt.Registry) error {
...
func (m *PaymentsForInvoiceTransactionOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PaymentsForInvoiceTransactionOKBody) UnmarshalBinary(b []byte) error {
