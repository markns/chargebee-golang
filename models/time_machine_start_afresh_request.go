...
func (m *TimeMachineStartAfreshRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TimeMachineStartAfreshRequest) UnmarshalBinary(b []byte) error {
	var res TimeMachineStartAfreshRequest
