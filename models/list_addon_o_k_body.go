...
func (m *ListAddonOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListAddonOKBody) validateList(formats strfmt.Registry) error {
...
func (m *ListAddonOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ListAddonOKBody) UnmarshalBinary(b []byte) error {
