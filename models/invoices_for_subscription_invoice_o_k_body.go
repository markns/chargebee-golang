...
func (m *InvoicesForSubscriptionInvoiceOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InvoicesForSubscriptionInvoiceOKBody) validateList(formats strfmt.Registry) error {
...
func (m *InvoicesForSubscriptionInvoiceOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *InvoicesForSubscriptionInvoiceOKBody) UnmarshalBinary(b []byte) error {
