...
// WithID adds the id to the retrieve subscription params
func (o *RetrieveSubscriptionParams) WithID(id string) *RetrieveSubscriptionParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the retrieve subscription params
func (o *RetrieveSubscriptionParams) SetID(id string) {
	o.ID = id
}
