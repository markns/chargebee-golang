...
// WithID adds the id to the delete comment params
func (o *DeleteCommentParams) WithID(id string) *DeleteCommentParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete comment params
func (o *DeleteCommentParams) SetID(id string) {
	o.ID = id
}
