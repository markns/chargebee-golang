...
type ListHostedPageOKBody struct {
	...
	// list
	// Required: true
	List []*models.HostedPageResponse `json:"list"`
...
/* polymorph ListHostedPageOKBody list false */

/* polymorph ListHostedPageOKBody next_offset false */

// Validate validates this list hosted page o k body
func (o *ListHostedPageOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *ListHostedPageOKBody) validateList(formats strfmt.Registry) error {

	if err := validate.Required("listHostedPageOK"+"."+"list", "body", o.List); err != nil {
		return err
	}
		...
		if o.List[i] != nil {
			...
			if err := o.List[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("listHostedPageOK" + "." + "list" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *ListHostedPageOKBody) validateNextOffset(formats strfmt.Registry) error {

	if err := validate.Required("listHostedPageOK"+"."+"next_offset", "body", o.NextOffset); err != nil {
		return err
	}
...
func (o *ListHostedPageOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *ListHostedPageOKBody) UnmarshalBinary(b []byte) error {
