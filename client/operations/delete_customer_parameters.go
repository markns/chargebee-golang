...
type DeleteCustomerParams struct {
	...
	CustomerDeleteRequest *models.CustomerDeleteRequest
	/*ID*/
	ID string
...
// WithCustomerDeleteRequest adds the customerDeleteRequest to the delete customer params
func (o *DeleteCustomerParams) WithCustomerDeleteRequest(customerDeleteRequest *models.CustomerDeleteRequest) *DeleteCustomerParams {
	o.SetCustomerDeleteRequest(customerDeleteRequest)
	return o
}

// SetCustomerDeleteRequest adds the customerDeleteRequest to the delete customer params
func (o *DeleteCustomerParams) SetCustomerDeleteRequest(customerDeleteRequest *models.CustomerDeleteRequest) {
	o.CustomerDeleteRequest = customerDeleteRequest
}

// WithID adds the id to the delete customer params
func (o *DeleteCustomerParams) WithID(id string) *DeleteCustomerParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete customer params
func (o *DeleteCustomerParams) SetID(id string) {
	o.ID = id
}
...
func (o *DeleteCustomerParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.CustomerDeleteRequest == nil {
		o.CustomerDeleteRequest = new(models.CustomerDeleteRequest)
	}

	if err := r.SetBodyParam(o.CustomerDeleteRequest); err != nil {
		return err
	}
